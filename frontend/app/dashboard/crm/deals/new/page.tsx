...
import { useCreateDeal, useContacts } from '@/lib/api/crm'
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">New Deal</h1>
          <p className="text-muted-foreground text-lg">Create a new deal in your pipeline</p>
        </div>
      </motion.div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <Button type="button" variant="outline" asChild>
                  <Link href="/dashboard/crm/deals">Cancel</Link>
                </Button>
              </div>
            </form>
          </CardContent>
